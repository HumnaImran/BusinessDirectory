...
class Eventful {
    ...
    public function start_import($overwrite = FALSE, $event_type='food', $category='', $activated = TRUE, $eventful_limit_page = 1, $eventful_offset_page=0, $max_images=1,  $developer_mode = FALSE) {
        ...
        for($page_number = $eventful_offset_page+1, $page_count = 1; $page_count<=$eventful_limit_page; $page_number++,$page_count++) {
            ...
            $this->import($overwrite, $event_type, $category, $activated, 250, $page_number, $max_images, $developer_mode);
     ...
     * 
     */
    private function import($overwrite = FALSE, $event_type='food', $category='', $activated = TRUE, $page_size=250, $page_number=1, $max_images=1, $developer_mode = FALSE) {

        $this->category = $category;
        
        $url= "http://api.eventful.com/rest/events/search?app_key=".$this->api_token."&category=".$event_type."&image_sizes=whiteborder500&page_size=".$page_size.'&=page_number='.$page_number;
     ...
     * 
     */
    public function get_count_pages($event_type='music', $page_size=250){
        
        $url= "http://api.eventful.com/rest/events/search?app_key=".$this->api_token."&category=".$event_type."&image_sizes=whiteborder500&page_size=".$page_size;
        ...
        $page_count = $this->get_XmlValue($xml_root, 'page_count', false);
