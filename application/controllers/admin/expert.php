...
class Expert extends Admin_Controller
{
    ...
    public function index($category_id = 0, $pagination_offset=0)
	{
        ...
        $config['total_rows'] = sw_count($this->data['questions']);
        $config['per_page'] = 20;
    ...
    public function edit($id = NULL)
	{
	    ...
	    if($id)
        {
            ...
            sw_count($this->data['expert']) || $this->data['errors'][] = 'Could not be found';
        }
        else
        {
    ...
    public function edit_category($id = NULL)
	{
        ...
        {
            $this->data['expert'] = $this->qa_m->get_lang($id, FALSE, $this->data['content_language_id']);
            sw_count($this->data['expert']) || $this->data['errors'][] = lang_check('Could not be found');
        }
        else
        {
            $this->data['expert'] = $this->qa_m->get_new();
