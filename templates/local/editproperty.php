                                ...
                                <div class="widget widget-styles affix-parent">
                                    ...
                                    <div class="content-box local-form">
                                        ...
                                        <?php echo form_open(NULL, array('class' => 'form-estate form-editproperty', 'role'=>'form'))?>                              
                                            ...
                                            <div class="form-group">
                                                <label for="inputVisible" class="control-label"><?php echo lang_check('Listing visible for public') ?> <?php echo form_checkbox('is_visible', '1', set_value('is_visible', $estate['is_visible']), 'id="inputVisible" style="margin-left: 5px;margin-top: 5px;vertical-align: top;"')?></label>
                                            </div>
                                                ...
                                                <div style="padding-top: 9px;" class="tab-content">
                                                    ...
                                                    foreach ($this->option_m->languages as $key => $val):$i++; ?>
                                                        ...
                                                        <?php elseif($val_option['type'] == 'CHECKBOX'):?>
                                                            <div class="control-group<?php echo ($val_option['is_frontend']?'':' hidden') ?> control-group-checkbox">
                                                                <label for="inputOption_<?php echo $key;?>_<?php echo $val_option['id'];?>" class="control-label"><?php echo $required_notice.$val_option['option']?><?php if(!empty($val_option['hint'])):?><i class="icon-question-sign hint" data-hint="<?php echo $val_option['hint'];?>"></i><?php endif;?></label>
                                                                <?php if($is_not_translatable):?>
                                                                <div class="controls">
                                                                    <div class="alert alert-warning non-translatable" role="alert"><?php echo lang_Check('Not translatable');?></div>
