...
<div class="widget widget-styles widget_edit_enabled">
    <h2 class="widget-title text-center content"><?php echo lang_check('Mortgage');?></h2>
    <div class="content-box pt0 text-center">
        <form method="get" action="#" class="bottom-line line-before form-light"  id="mortgage_calculator">
            ...
            <input type="submit" class="btn btn-custom btn-custom-secondary btn-wide" value="<?php _l('Calculate'); ?>" />
        </form>
    </div>
