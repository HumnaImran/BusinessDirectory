...
Widget-preview-image: /assets/img/widgets_preview/top_recentlistings.jpg
 */
?>

<section class="section widget-recentproperties container container-palette bg-default widget-top_recentlistings">
    <div class="header">
