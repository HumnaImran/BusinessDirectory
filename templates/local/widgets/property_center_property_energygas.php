<?php if(file_exists(FCPATH.'templates/'.$settings_template.'/assets/js/dpejes/dpe.js') && (!empty($options_name_59)|| !empty($options_name_60))): ?>
<div class="widget-styles widget_edit_enabled">
    <div class="header content t-left">
       <h2><?php echo lang_check('Energy efficient');?></h2>
    </div>
