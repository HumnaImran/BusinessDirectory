...
clusters = L.markerClusterGroup({
        ...
        iconCreateFunction: function (cluster) {
            ...
            return new L.DivIcon({ html: '<div><span>' + childCount + '</span></div>', className: 'leaflet-marker-icon marker-cluster marker-cluster-small leaflet-zoom-animated leaflet-interactive', iconSize: new L.Point(40, 40) });
        },
