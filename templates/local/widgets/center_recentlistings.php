 <?php
/*
Widget-title: Recentlistings results
Widget-preview-image: /assets/img/widgets_preview/center_recentlistings.jpg
 */
?>

<section class="section widget-recentproperties widget-center-recentproperties bg-default pt20 widget_edit_enabled">
    <div class="header">
        ...
        <div class="filters filters-box list-view-box clearfix no-padding-side">
