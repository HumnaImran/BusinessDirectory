...
<?php
    ...
    echo form_dropdown('option'.$field_id.'_'.$lang_id.'_level_0', array_replace($drop_options,array(''=>lang_check('All categories'))), $drop_selected, 'class="form-control selectpicker base no-padding tree-input" id="sinputOption_'.$lang_id.'_'.$field_id.'_level_0'.'"');
    echo '</div>';
